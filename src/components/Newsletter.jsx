...
const Newsletter = () => {
  return (
    <div className='md:-mt-[164px] sm:-mt-[150px] -mt-[126px]'>
      <div className=' conatiner mx-auto max-w-[1180px] px-5'>
        <div className='w-full bg-news bg-full bg-center bg-no-repeat rounded bg-light-blue py-6 sm:py-10 md:py-[54px] px-5 md:translate-y-[164px] sm:translate-y-[150px] translate-y-[126px]'>
