    ...
    <div className="py-4">
      <div className="container max-w-[1180px] px-5 mx-auto">
        <div className="flex justify-between items-center">
          ...
          <ul
            className={`flex  items-center gap-4 xl:gap-6 max-lg:z-20 max-lg:justify-center max-lg:flex-col max-lg:fixed max-lg:right-0 max-lg:top-0 max-lg:bg-[#09476E] max-lg:w-full max-lg:h-screen  duration-300 ${
          ...
          >
            ...
            <li className="max-sm:block hidden">
              <button
                ...
                className="w-full hover:bg-black duration-300 group py-3.5 px-5 max-w-[154px] text-deep-blue hover:text-white rounded-[0px_50px_50px_40px] bg-white flex font-bold text-base items-center text-nowrap l!eading-112"
              >
                Get Started
                <span>
